...
public class Principal {
    /**
     * Listas de veiculos para o armazenamento.
     */
    ...
    /**
        *Menu de opções que possibilita o cadastro, edição, remoção e exibição de dados conforme o item escolhido.
     */
    private static final String menu = "Sistema CRUD Concessionaria\n\n"
            + "1 --> Cadastrar Veiculo\n"
            + "2 --> Editar Veiculo\n"
            + "3 --> Excluir Veiculo\n"
    ...
    private static final String menuCadastroVeiculo = "Sistema CRUD Concessionaria\n\n"
            + "1 --> Cadastrar Carro\n"
            + "2 --> Cadastrar Moto\n"
            + "3 --> Cadastar Caminhão\n\n"
            + "4 --> Voltar\n";
    
    private static final String selecaoExibicao = "Sistema CRUD Concessionaria\n\n"
    ...
    private static final String menuDeletar ="Sistema CRUD Concessionaria\n\n"
    ...
    private static final String menuAlterar = "Sistema CRUD Concessionaria\n\n"
    ...
    /*
        *Menu de interação que puxa o tipo de veiculo para ser cadastrado
     */
            ...
            switch(opcaoA){
                case 1:
                    if(listaDeCarros.isEmpty()){ //Tratamento de erro caso a lista esteja vazia
                        ...
                        int index = Integer.parseInt(JOptionPane.showInputDialog("Sistema CRUD Concessionaria\n\n" + "Insira o codigo de cadastro do veiculo que você deseja alterar" + 
